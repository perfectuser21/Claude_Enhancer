...
class JWTTokenManager:
    ...
    def generate_token_pair(self, user_id: str, permissions: List[str] = None, 
    ...
    def refresh_token(self, refresh_token: str, client_ip: str = None, 
...
class TestJWTTokenManager:
    ...
    def test_token_payload_structure(self, jwt_manager, sample_user_data):
        ...
        required_fields = ["sub", "type", "iat", "exp", "permissions", "device_info", "ip_address"]
        ...
        required_refresh_fields = ["sub", "type", "iat", "exp", "device_info", "ip_address"]
