...
class LoginRequest(BaseModel):
    ...
    device_info: Optional[Dict[str, Any]] = Field(
        default_factory=dict, description="设备信息"
    )
...
class RefreshTokenRequest(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {"refresh_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..."}
        }
...
class MFAEnableRequest(BaseModel):
    ...
    class Config:
        schema_extra = {
            "example": {"method": "totp", "current_password": "CurrentPassword123!"}
        }
    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "message": "请求参数验证失败",
                "details": {"field": "password", "constraint": "minimum_length"},
                "timestamp": "2023-12-01T12:00:00Z",
                "request_id": "req_123",
            }
        }
