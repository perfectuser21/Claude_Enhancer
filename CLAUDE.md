...
├─ 触发：Phase 0完成后自动触发（通过PrePrompt hook）
├─ 活动：
│  ├─ 分析任务描述（风险、复杂度、影响范围）
│  ├─ 计算影响半径分数（0-100分）
...
- Step 3 → Step 4：Phase 0完成后自动触发影响半径评估
