...
class SmartDispatcher:
    ...
    def _route_security_check(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool in ["Bash", "Shell"]:
            ...
            if any(p in context.input_data.lower() for p in dangerous_patterns):
                return (
                    True,
                    "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/security_validator.py",
                )
        return False, ""
    ...
    def _route_agent_validation(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool == "Task" and "subagent_type" in context.input_data:
            return (
                True,
                "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py validate-agents",
            )
        return False, ""
    ...
    def _route_quality_check(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool in ["Edit", "Write", "MultiEdit"]:
            return (
                True,
                "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py pre-edit",
            )
        return False, ""
    ...
    def _route_formatting(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool in ["Edit", "Write", "MultiEdit"] and context.file_paths:
            ...
            if any(
                Path(f).suffix in formattable_extensions for f in context.file_paths
            ):
                return (
                    True,
                    "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py format-code",
                )
        return False, ""
    ...
    def _route_test_analysis(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool == "Bash":
            ...
            if any(ind in context.input_data.lower() for ind in test_indicators):
                return (
                    True,
                    "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py analyze-test-results",
                )
        return False, ""
    ...
    def _route_commit_preparation(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if context.tool == "Bash" and "git commit" in context.input_data:
            return (
                True,
                "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/git_helper.py prepare-commit",
            )
        return False, ""
    ...
    def _route_task_analysis(self, context: HookContext) -> Tuple[bool, str]:
        ...
        return (
            True,
            "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py analyze-task",
        )
    ...
    def _route_context_injection(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if any(
            kw in context.input_data.lower()
            for kw in ["implement", "create", "build", "develop"]
        ):
            return (
                True,
                "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/context_injector.py",
            )
        return False, ""
    ...
    def _route_completion_check(self, context: HookContext) -> Tuple[bool, str]:
        ...
        return (
            True,
            "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py check-completion",
        )
    ...
    def _route_summary_generation(self, context: HookContext) -> Tuple[bool, str]:
        ...
        if self.stats["total"] > 10:
            return (
                True,
                "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py generate-report",
            )
        return False, ""
    ...
    def _route_initialization(self, context: HookContext) -> Tuple[bool, str]:
        ...
        return (
            True,
            "python3 /home/xx/dev/Claude Enhancer/.claude/hooks/claude_enhancer_core.py load-context",
        )
