...
class PerformanceOptimizer:
    ...
    def record_metric(self, metric_name: str, value: float, context: Dict[str, Any] = None, tags: List[str] = None):
    ...
    def optimize_automatically(self, max_optimizations: int = 3) -> List[OptimizationResult]:
        ...
        bottlenecks.sort(key=lambda x: self._severity_to_score(x.get('severity', 'low')), reverse=True)
    ...
    def get_optimization_report(self) -> Dict[str, Any]:
        ...
        recommendations = self._generate_comprehensive_recommendations(analysis, system_stats)
        ...
        return {
            ...
            'optimization_history': [asdict(opt) for opt in list(self.optimization_history)],
        ...
        try:
            ...
            if os.path.exists(agent_log_file):
                ...
                if total_selections > 0:
                    ...
                    metrics['complex_task_ratio'] = complexity_counts.get('complex', 0) / total_selections
    ...
    def _get_cache_metrics(self) -> Dict[str, float]:
        ...
        try:
            ...
            metrics['cache_utilization'] = min(100, total_cache_files / 50 * 100)  # Assume 50 is optimal
    ...
    def _optimize_hook_execution(self, bottleneck: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
    ...
    def _optimize_agent_selection(self, bottleneck: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
    ...
    def _optimize_memory_usage(self, bottleneck: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
    ...
    def _optimize_caching(self, bottleneck: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """Optimize caching performance"""
        # Placeholder for cache optimization logic
        return True, "Cache optimization applied"

    def _optimize_disk_io(self, bottleneck: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
