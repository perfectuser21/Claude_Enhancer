...
class PerformanceTestSuite:
    ...
    # print("🔬 Testing Hook Latency...")
        ...
        original_validator = "/home/xx/dev/Claude Enhancer/.claude/hooks/agent_validator.sh"
        ...
        optimized_validator = "/home/xx/dev/Claude Enhancer/.claude/hooks/fast_agent_validator.sh"
        for _ in range(5):  # Reduced for faster testing
            start_time = time.time()
            try:
                subprocess.run(
    ...
    # print("💾 Testing Cache Performance...")
        ...
        dispatcher_path = "/home/xx/dev/Claude Enhancer/.claude/hooks/performance_optimized_dispatcher.py"
    ...
    # print("📊 Testing Resource Usage...")
        ...
        monitor_path = "/home/xx/dev/Claude Enhancer/.claude/hooks/resource_monitor.py"
    ...
    def _run_stress_test(self) -> Dict[str, Any]:
        ...
        def run_validation():
            validator_path = "/home/xx/dev/Claude Enhancer/.claude/hooks/fast_agent_validator.sh"
