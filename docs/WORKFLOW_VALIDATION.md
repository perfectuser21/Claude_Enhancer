...
**它做什么**：
1. **检查Phase 0-5的完成情况** - 像装修监理检查每个房间
2. **生成证据文件** - 像装修照片和质检报告
3. **计算完成百分比** - 像装修进度条：[██████████░] 85%
...
Phase 0: Discovery (探索与验收) - 10 steps
...
**要做**：
```
Phase 0 → 验证 → Phase 1 → 验证 → Phase 2 → 验证 ...
